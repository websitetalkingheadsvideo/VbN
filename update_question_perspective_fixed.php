<?php
// update_question_perspective_fixed.php - Fixed version with better output
include "includes/connect.php";

echo "<h2>Updating Perspective Question</h2>";
...
if ($stmt) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        echo "<p style='color: green;'>✅ Perspective question updated to scenario successfully!</p>";
...
$verify_sql = "SELECT category, question FROM questionnaire_questions WHERE id = 144";
