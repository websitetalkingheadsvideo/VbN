...
if ($result) {
    ...
    $descriptions = [
        "pre_embrace" => "Pre-Embrace Life Scenarios (Questions 1-10)",
        "post_embrace" => "Post-Embrace Vampire Experiences (Questions 11-20)", 
        ...
        "scenario" => "Hypothetical Scenarios (Questions 30-34)",
        "workplace" => "Professional Situations (Question 35)",
        "family" => "Family & Relationships (Question 36)",
        "social" => "Social Interactions (Question 37)",
        "moral" => "Moral Dilemmas (Question 38)",
        "power" => "Power & Authority (Question 39)",
