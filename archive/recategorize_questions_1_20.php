<?php
// Recategorize pre_embrace and post_embrace questions (1-20) to use specific categories like questions 21-40
include "includes/connect.php";

// Define the specific category mappings for questions 1-20
$categoryMappings = [
    // Pre-Embrace Questions (1-10) - map to specific categories
    ...
    // Post-Embrace Questions (11-20) - map to specific categories
...
// Update the categories for questions 1-20
$updated = 0;
$errors = 0;
...
echo "<p>Updated: $updated questions (1-20)</p>";
...
if ($result) {
    echo "<h3>Updated Category Distribution (All 40 Questions):</h3>";
