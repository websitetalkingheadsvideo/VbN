<?php
// Final working save script with correct parameter count
...
try {
    ...
    // FIXED: 26 parameters with 26 type characters
    // Types: i s s s s s s s i s i s s s i i s i i i i i i i i i s
    mysqli_stmt_bind_param($stmt, 'isssssssissssiisiiiiiiiiis',
        ...
        $notes,                     // s
        $experience_total,          // i
        $experience_unspent,        // i
        $morality_path,             // s
        $conscience,                // i
        $self_control,              // i
        $courage,                   // i
        $path_rating,               // i
        $willpower_permanent,       // i
        $willpower_current,         // i
        $blood_pool_max,            // i
        $blood_pool_current,        // i
        $health_status              // s
    );
