<?php
/**
 * Import Rembrandt Jones from JSON
 * Command-line script following run_migration.php pattern
 */
...
echo "=================================================================\n";
echo "Rembrandt Jones Character Import\n";
echo "=================================================================\n\n";
...
$json_file = __DIR__ . '/Rembrandt Jones.json';

if (!file_exists($json_file)) {
    die("❌ JSON file not found: $json_file\n");
}

echo "📄 Reading character file: Rembrandt Jones.json\n\n";
...
try {
    ...
    // 6. Insert disciplines (new normalized structure: one row per discipline with max level)
    ...
    echo "=================================================================\n";
    echo "✅ Rembrandt Jones imported successfully\n";
